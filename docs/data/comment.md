...
<ul class="padding-left-md">
    <li class="row padding-top-lg border-bottom-light">
        ...
        <div class="flex margin-left-md">
            <div class="row">
                <p class="flex margin-top-md"><span class="font-weight-bold">username</span> <a class="color-link" href="">@username</a> content content content content content content</p>
            ...
            <div class="color-gray-light font-size-xs">
                <time>7小时</time>
                <span class="margin-left-lg font-weight-bold">1次赞</span>
                <button class="font-weight-bold button-transparent margin-left-sm color-gray-light">回复</button>
            </div>

            <div class="font-size-xs color-gray-light">
                <span>——</span>
                <span class="margin-left-md">查看回复 (1)</span>
            </div>
